...
/**
 * GET /api/sm/livescores/inplay?include=participants:name,image_path;scores&filters=fixtureLeagues:501,271
 * Fetch all inplay fixtures (live matches)
 * 
 * Query parameters:
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await sportmonksClient.getLivescoresInplay({
      include,
      select: query.select,
